...
(check-equal? (actual-value '(define (square x) (* x x)) the-global-environment) 'eval-definition)
(check-equal? (actual-value '(square (id 10)) the-global-environment) 100)
(check-equal? (actual-value 'count the-global-environment) 1) ; メモ化によって 1 に変わる。
