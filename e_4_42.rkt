...
; 追加実装箇所
; https://wizardbook.wordpress.com/2011/01/12/exercise-4-42/
; and と or を利用していたため実装した。
(define (analyze exp)
  (cond ((self-evaluating? exp) 
        ...
        ((and? exp) (analyze-and (and-actions exp)))
        ((or? exp) (analyze-or (or-actions exp)))
...
(check-equal? (eval '(and true false)) false)
(check-equal? (eval '(and true true)) true)
