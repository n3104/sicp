...
; https://wizardbook.wordpress.com/2011/01/13/exercise-4-43/
(eval
 '(define (sailors)
...
(eval
 '(define (sailors-2)
    ...
    (let ((moore   (list 'moore (amb 'gabrielle 'mary-ann 'rosalind) 'lorna))
          (hood    (list 'hood  'melissa                'gabrielle))
          (hall    (list 'hall  (amb 'gabrielle 'lorna 'mary-ann) 'rosalind))
          (downing (list 'downing (amb 'gabrielle 'lorna 'rosalind 'mary-ann) 'melissa))
          (parker (list 'parker  (amb 'gabrielle 'lorna 'rosalind) 'mary-anne)))
