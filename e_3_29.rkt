...
(define (or-gate a1 a2 output)
  (define a1-inverter-out (make-wire))
  (define a2-inverter-out (make-wire))
  (define and-out (make-wire))
  (inverter a1 a1-inverter-out)
  (inverter a2 a2-inverter-out)
  (and-gate a1-inverter-out a2-inverter-out and-out)
